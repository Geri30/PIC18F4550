...
# 17 "intento con servo.c" 2


unsigned char min=0, seg=0, cent=0;
unsigned char pase=0,alfa=0,acaba=0;

void mover (void){
    for(int j=0;j<10;j++){
        LATBbits.LB0 = 1;
        _delay((unsigned long)((600)*(48000000UL/4000000.0)));
        LATBbits.LB0 = 0;
        _delay((unsigned long)((19)*(48000000UL/4000.0)));
        _delay((unsigned long)((400)*(48000000UL/4000000.0)));
    }
    for(int j=0;j<10;j++){
        LATBbits.LB0 = 1;
        _delay((unsigned long)((400)*(48000000UL/4000000.0)));
...
void main(void) {
    ...
    while(1){
        ...
        if(acaba==1 && alfa==1){
            alfa=0;
        if(seg%5==0 && seg>0 && cent==0){
            pase=0;
            mover();
        }
        if(pase==1 && cent==0 && seg==0){
            pase=0;
            mover();
            mover();
        }
...
void __attribute__((picinterrupt(("high_priority")))) elcomparador(void){
    PIR1bits.CCP1IF=0;
    cent++;
...
void __attribute__((picinterrupt(("low_priority")))) elboton(void){
